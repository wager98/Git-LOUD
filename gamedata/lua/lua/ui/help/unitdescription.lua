...
--UEF UNITS
	...
	['uel0001-exles3'] = "<LOC Unit_Description_0455>Adds the ability to construct T4 units and increases build power to 15x, regen by 10x and health doubled, from the base values. Movement speed increased by 10%",
...
--CYBRAN UNITS
	...
	['url0001-exles3'] = "<LOC Unit_Description_0456>Adds the ability to construct T4 units and increases build power to 15x, regen by 10x and health doubled, from the base values. Movement speed increased by 10%",
    ...
    ['url0307'] = "<LOC Unit_Description_0457>Mobile Sensor Disruptor and Stealth Field.  Disrupts enemy sensors (radar,sonar,Omni & Vision) upto 40%",
	...
	['bra0309'] = "<LOC Unit_Description_0458>High-end covert operations air transport. Equipped with a cloak generator, it can become very useful to a clever Commander. Can transport up to 16 Small hook, 14 Medium hook or 3 Large hook units.",
...
--AEON UNITS
	...
	['ual0001-exles3'] = "<LOC Unit_Description_0459>Adds the ability to construct T4 units and increases build power to 15x, regen by 10x and health doubled, from the base values. Movement speed increased by 10%",
	...
	['baa0309'] = "<LOC Unit_Description_0460>High-end air transport. This transport makes up for its lack of armor through agility. Can transport up to 24 Small hook, 12 Medium hook or 6 Large hook units.",
...
--SERAPHIM UNITS
	...
	['xsl0001-exles3'] = "<LOC Unit_Description_0461>Adds the ability to construct T4 units and increases build power to 15x, regen by 10x and health doubled, from the base values. Movement speed increased by 10%",
	...
	['bsa0309'] = "<LOC Unit_Description_0462>High-end air transport. Has weak armor but makes up for this with its large carrying capacity, its speed and Lambda Field Generators for annihilating and deflecting projectiles. Can transport up to 32 Small hook, 16 Medium hook or 8 Large hook units.",
	...
	['xss0403'] = "<LOC Unit_Description_0463>Fast and robust cruiser with devastating AA weapons and a powerful surface weapon",
